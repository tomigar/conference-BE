...
@section('page-title', 'Add New Conference')
@section('page-subtitle', 'Create a new conference year with all details')
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Create New Conference Year</h5>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('conferences.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year') }}" required min="2000">
                                @error('year')
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> Save Conference
                                </button>
                            </div>
                        </form>
                    </div>
